...
public class GoPackageMatcher extends CommonPackageMatcher {

    public GoPackageMatcher(String[] libraryFilePaths) throws IOException {
 ...
 * Go's analyzer
 */
class GoPackageAnalyzer extends CommonPackageAnalyzer {
    @Override
    protected TokenStreamComponents createComponents(String s) {
        Tokenizer tokenizer = new LetterAndDigitTokenizer();
        TokenStream stream;
        stream = new RemovingDomainFilter(tokenizer);
