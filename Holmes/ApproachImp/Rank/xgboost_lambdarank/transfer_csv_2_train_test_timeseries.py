...
def read_data(exp_type):
    ...
    with open(f"./{exp_type}/qid_cveid_map.json", "w") as fw:
...
def save_libsvm(exp_type):
    ...
    return qid_index_componentname_map, raw_data, raw_group, qid_cveid_map
